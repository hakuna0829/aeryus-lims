...
Signature.propTypes = {
  ...
  getLocationSignature: PropTypes.array.isRequired,
  addLocationSignature: PropTypes.array.isRequired,
  uploadLocationSignature: PropTypes.array.isRequired
};

export default connect(mapStateToProps, { getLocationSignature, addLocationSignature, uploadLocationSignature })(withRouter(Signature));