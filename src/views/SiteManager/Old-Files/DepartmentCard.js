            ...
            <div >
                <div className={classes.locationLogo}>
                    <img
                        src={
                            location.active
                                ? '/images/svg/department_active.svg '
                                : '/images/svg/department_inactive.svg'
                        }
                        alt=""
                    />
                </div>
                <CardContent className={classes.cardcontent}>
                    ...
                    <div className={classes.linkContainer}>
                        <Button
                            component={Link}
                            to={{
                                pathname: "/site-manager/department-details", state: { locationDetails: location }
                            }}
                            className={
                                location.active
                                    ? `${classes.viewLink}`
                        ...
                        <Button
                            component={Link}
                            to={{
                                pathname: "/site-manager/department-staff", state: { locationDetails: location }
                            }}
                            className={
                                location.active
                                    ? `${classes.viewLink}`
