            ...
            {step === 0 && <>
                <Grid container direction="column" justify="center" alignitems="center">
                    <Grid container direction="row" justify="center" alignitems="center">
                        <Typography variant="h6" style={{ marginTop: '10px', marginBottom: '20px' }}>We need the patient and technician’s signatures for consent to administer the Rapid Test</Typography>
                    </Grid>
                    <Grid container direction="row" justify="center" alignitems="center">
...
RapidTracker.propTypes = {
    getPatient: PropTypes.func.isRequired,
    // upsertPatient: PropTypes.func.isRequired
}
export default connect(null, { getPatient, upsertPatient })(RapidTracker);