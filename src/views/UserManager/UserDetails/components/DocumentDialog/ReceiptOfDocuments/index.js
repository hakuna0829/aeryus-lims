...
const ReceiptOfDocuments = props => {
    ...
    <div>
      ...
      >
        ...
        <DialogContent
          ...
          ref={componentRef}
        >
          <Typography variant="h4" className={classes.cardTitle}>RECEIPT OF DOCUMENTS</Typography>
          ...
          <Typography variant="h5" className={classes.contentText}>
            The patient/legal guardian acknowledges receipt of TESTD | MD Policies and Procedures. <br />
            ...
            The client/legal guardian ACCEPTS or REJECTS copies. <br />
          </Typography>
          <br /><br />
          {data.receipt_of_documents && data.receipt_of_documents.signature &&
            <div className={classes.boxContainer}>
              <img src={apiUrl + data.receipt_of_documents.signature} alt="signature" />
            </div>
          }
          <br /><br />
          <Grid container direction="column" justify="center" alignItems="center" >
            {data.receipt_of_documents && data.receipt_of_documents.submitted_timestamp &&
              <Grid item className={classes.cardContentItem}>
                <Typography className={classes.cardContentLabel}>Date/Time Stamp: </Typography>
                <Typography className={classes.cardContentValue}>{moment(data.receipt_of_documents.submitted_timestamp).format('MM/DD/YYYY h:mm A')}</Typography>
              </Grid>
            }
            <Grid item className={classes.cardContentItem}>
              <Typography className={classes.cardContentLabel}>Session ID: </Typography>
...
ReceiptOfDocuments.propTypes = {
  open: PropTypes.bool.isRequired,
  data: PropTypes.any.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default ReceiptOfDocuments;