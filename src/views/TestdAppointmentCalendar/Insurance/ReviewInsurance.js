...
const ReviewInsurance = (props) => {
  const { patient, handleInsuranceSubmit, backTab } = props;
    ...
    <div className={classes.content} >
      <div className={classes.contentBody}>
        ...
        <Typography className={classes.description}>
          Please review both photos<br />
          and make sure they are clear,<br />
          legible and the most updated
        </Typography>
        ...
        <div className={classes.boxContainer} >
          ...
          <div className={classes.uploadContanier}>
            ...
            {patient && patient.insurance && patient.insurance.primary_insurance_card_front && (
              <>
                <img src={apiUrl + patient.insurance.primary_insurance_card_front} className={classes.uploadedPhoto} alt="img" />
          ...
          <div className={classes.uploadContanier}>
            ...
            {patient && patient.insurance && patient.insurance.primary_insurance_card_back && (
              <>
                <img src={apiUrl + patient.insurance.primary_insurance_card_back} className={classes.uploadedPhoto} alt="img" />
