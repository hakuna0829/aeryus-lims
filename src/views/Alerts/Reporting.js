...
const data = [
  {
    id: 1,
    label: 'Specimen report <br /> summary',
    image: 'specimen_report_summary_1.png'
  },
  {
    id: 2,
    label: 'Daily test <br /> summary',
    image: 'daily_test_summary.svg'
  },
  {
    id: 3,
    label: 'Weekly SMS and <br /> email summary',
    image: 'weekly_sms_email_summary.svg'
  },
  {
    id: 4,
    label: 'Vaccine appointment <br /> confimation Pfizer <br />(21 days)',
    image: 'vaccine_appointment_confirm_pfizer.svg'
  },
  {
    id: 5,
    label: 'Vaccine appointment <br /> confimation Moderna <br/> (28 days)',
    image: 'vaccine_appointment_confirm_moderna.svg'
  },
  {
    id: 6,
    label: 'Testd Connect',
    image: 'Testd_connect.svg'
  },
]

const ReportingAlerts = (props) => {
    ...
    <div className={classes.root}>
      <div className={classes.header}>
        <Box >
          ...
          <Typography variant="h4" className={classes.headerSubTitle}>Reporting alerts</Typography>
          {/* <sup>
            <Tooltip title="Reporting Alerts" placement="right-start" style={{margin:'-10px 0 0 10px'}}>
              <HelpIcon />
            </Tooltip>
          </sup> */}
        </Box>
                ...
                <Grid item xs={4} key={item.id}>
                  <Box className={classes.itemContainer} position="relative">
                    <Box className={classes.imageBox}>
                      <img src={'/images/svg/alerts/reporting/'+item.image} alt="item.label" />
                    </Box>
...
export default withRouter(ReportingAlerts);