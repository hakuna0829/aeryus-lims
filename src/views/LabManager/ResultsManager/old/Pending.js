...
const columns = [
  ...
  { id: 'test_id', label: 'ID Number', minWidth: 150 },
...
const headCells = [
  ...
  { id: 'test_id', numeric: false, disablePadding: true, label: 'ID Number' },
  {
    id: 'detail',
    numeric: false,
    disablePadding: false,
      ...
      <TableRow>
        {headCells.map(headCell => (
          <TableCell
            ...
            align={
              headCell.id === 'detail' || headCell.id === 'status'
                ? 'center'
                : 'left'
            }
    ...
    if (column.id === 'status') {
      return (
        <TableCell
          ...
          {!value ? (
            <Button variant="outlined" className={classes.statusBtn}>
              INTERPRET
            </Button>
          ) : (
            <Button variant="outlined" className={classes.statusBtn}>
