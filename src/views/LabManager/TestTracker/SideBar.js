    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.totalOrders} >
                ...
                <Typography variant="h1" className={classes.totalValue}>2025</Typography>
                <hr className={classes.divider}/>
                <Typography variant="h6" className={classes.totalTitle}>Total orders shipped</Typography>
                <Typography variant="h1" className={classes.totalValue}>2025</Typography>
            </div>
            ...
            <div className={classes.pcrOrders} >
                <Typography variant="h6" className={classes.pcrTitle}>PCR orders</Typography>
                <Typography variant="h1" className={classes.pcrValue}>1000</Typography>
                <hr className={classes.divider}/>
                <Typography variant="h6" className={classes.pcrTitle}>PCR orders shipped</Typography>
                <Typography variant="h1" className={classes.pcrValue}>1000</Typography>
            </div>
